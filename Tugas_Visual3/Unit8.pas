...
if e_1.Text='' then
  begin
    ...
    if e_4.text=''then
    begin
    ShowMessage('EMAIL PEMBELIAN BELUM SESUAI');
    end else
    if e_5.text=''then
    begin
     ShowMessage('NAMA PT DIBELI BELUM SESUAI');
     end else
      if e_6.text=''then
      begin
     ShowMessage('NAMA SUPLIER BELUM SESUAI');
     end else
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into suplier values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'","'+e_6.Text+'",")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update suplier set id= "'+e_1.Text+'",alamat="'+e_2.Text+'",no_telepon="'+e_3.Text+'",email="'+e_4.Text+'",nama_pt ="'+e_5.Text+'",nama_supplier="'+e_6.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from suplier where id="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from suplier');
zqry1.Open;
