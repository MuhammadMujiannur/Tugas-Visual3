...
if e_1.Text='' then
  begin
    ...
    if e_4.text=''then
    begin
    ShowMessage('TELEPON PEMBELIAN BELUM SESUAI');
    end else
    if e_5.text=''then
    begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into pembeli values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'","'+e_6.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update pembeli set id= "'+e_1.Text+'",nama="'+e_2.Text+'",alamat="'+e_3.Text+'",telepon="'+e_4.Text+'",email ="'+e_5.Text+'",tgl_pembelian="'+e_6.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from pembeli where id="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from pembeli');
zqry1.Open;
