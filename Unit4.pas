...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('ID SUPLIER BELUM DIISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
    ...
    if e_4.text=''then
    begin
    ShowMessage('TANGGAL PEMBELIAN BELUM SESUAI');
    end else
    if e_5.text=''then
    begin
     ...
     if e_7.text=''then
      begin
     ShowMessage('JENIS PEMBAYARAN BELUM SESUAI');
     end else
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into kustomer values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'","'+e_6.Text+'","'+e_7.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update kustomer set id= "'+e_1.Text+'",id_supplier="'+e_2.Text+'",id_motor="'+e_3.Text+'",tanggal_pembelian="'+e_4.Text+'",jumlah_motor_dibeli ="'+e_5.Text+'",total_harga="'+e_6.Text+'",metode_pembayaran="'+e_7.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
